  ...
  return (
    ...
    <div className="py-20">
        ...
        <div className="grid grid-cols-2 justify-items-center">
            <div className="flex-row items-start justify-center justify-self-end card w-60 bg-zinc-800 rounded-none m-10 mt-2 mb-4">
            ...
            <div className="flex-row items-start justify-center justify-self-start card w-60 bg-zinc-800 rounded-none m-10 mt-2 mb-4">
