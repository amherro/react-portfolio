...
const AboutContact = () => {
  return (
    <div className='md:grid md:grid-cols-2 flex flex-col items-center p-10'>
        <div className="about-section card card-bordered bg-base-200 w-[300px] h-[275px] justify-self-center mb-3 md:m-0 bg-zinc-800">
        ...
        <div className="about-section card card-bordered bg-base-200 w-[300px] h-[275px] justify-self-start bg-zinc-800">
