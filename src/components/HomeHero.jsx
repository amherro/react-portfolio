...
import headshot from '../img/photo-home.JPG'
        ...
        <div className="hero pt-12 pb-10">
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div className='w-3/4 sm:w-1/2 pt-4 text-center sm:text-start'>
                    ...
                    <p className="py-6 lg:w-3/4">Feel free to browse my most recent projects on the Projects page. If you would like to get in touch, please use the information on the Contact page.</p>
                    <Link to='/projects'>
